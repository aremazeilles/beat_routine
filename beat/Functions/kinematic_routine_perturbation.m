...
angle_label2=cat(1,'NaN',angle_label');
ROM_d=cat(1,direction,num2cell(ROM)); %%add the header line with direction label
ROM_p=cat(2,angle_label2, ROM_d); %%add the firts column as the angle label