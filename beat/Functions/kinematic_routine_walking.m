...
filename = strcat(outFolder,"/pi_mrom.yaml");
store_pi_vector(filename, 1, '°', angle_label2, mROM);

%% save CoV value in .yaml file

filename = strcat(outFolder,"/pi_cov.yaml");
store_pi_vector(filename, 1, '%', angle_label2, CoV);
