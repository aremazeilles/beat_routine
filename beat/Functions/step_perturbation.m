...
dd=find(abs(diff(dir_l))==1)
dir_l(dd(1)+1:dd(2))=1;
dir_l(dd(3)+1:dd(4))=2;
dir_l(dd(5)+1:dd(6))=3;
dir_l(dd(7)+1:dd(8))=4;
dir_l(dd(11)+1:dd(12))=6;
dir_l(dd(13)+1:dd(14))=7;
dir_l(dd(15)+1:dd(16))=8;
...
for d=1:8
  angle_platform=acos(cos(platform_angle(dir_l(1,:)==d,1)).*cos(platform_angle(dir_l(1,:)==d,2)))*57.3;
  OS(d)= max(angle_platform)-imposed_angle); %%compute overshoot for each direction with respect the imposed perturbation
